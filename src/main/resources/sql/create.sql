CREATE TABLE Pessoa (
     pessoa_id MEDIUMINT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE Cliente (
     cliente_id MEDIUMINT AUTO_INCREMENT PRIMARY KEY,
     pessoa_id MEDIUMINT,
     /* TODO: necessidade de campos aqui */
     CONSTRAINT fk_pessoa_cliente FOREIGN KEY (pessoa_id) REFERENCES Pessoa (pessoa_id),
     INDEX (pessoa_id)
);

CREATE TABLE ClienteInteresse (
     interesse_id MEDIUMINT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE Funcionario (
     funcionario_id MEDIUMINT AUTO_INCREMENT PRIMARY KEY,
     pessoa_id MEDIUMINT,
     usuario VARCHAR(100),
     senha VARCHAR(50),
...
CREATE TABLE FuncionarioTelefone (
     funcionario_telefone_id MEDIUMINT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE Gerente (
     gerente_id MEDIUMINT AUTO_INCREMENT PRIMARY KEY,
     funcionario_id MEDIUMINT,
...
CREATE TABLE Vendedor (
     vendedor_id MEDIUMINT AUTO_INCREMENT PRIMARY KEY,
     funcionario_id MEDIUMINT,
     gerente_id MEDIUMINT,
     metaVendas MEDIUMINT,
...
CREATE TABLE Sala (
     sala_id MEDIUMINT AUTO_INCREMENT PRIMARY KEY,
     capacidade TINYINT,
     quatro_d TINYINT(1)
);

CREATE TABLE Classificacao (
     classificacao_id MEDIUMINT AUTO_INCREMENT PRIMARY KEY,
     nome VARCHAR(50)
);

CREATE TABLE Genero (
     genero_id MEDIUMINT AUTO_INCREMENT PRIMARY KEY,
     nome VARCHAR(50)
);

CREATE TABLE Filme (
     filme_id MEDIUMINT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE FilmeTresD (
     filme_tres_d_id MEDIUMINT AUTO_INCREMENT PRIMARY KEY,
     filme_id MEDIUMINT,
...
CREATE TABLE FilmeQuatroD (
     filme_quatro_d_id MEDIUMINT AUTO_INCREMENT PRIMARY KEY,
     filme_id MEDIUMINT,
...
CREATE TABLE Sessao (
     sessao_id MEDIUMINT AUTO_INCREMENT PRIMARY KEY,
     sala_id MEDIUMINT,
     filme_id MEDIUMINT,
     data_inicio DATE,
     data_fim DATE,
...
CREATE TABLE SessaoDia (
     sessao_dia_id MEDIUMINT AUTO_INCREMENT PRIMARY KEY,
     sessao_id MEDIUMINT,
     dia DATE,
...
CREATE TABLE Bilhete (
     bilhete_id MEDIUMINT AUTO_INCREMENT PRIMARY KEY,
