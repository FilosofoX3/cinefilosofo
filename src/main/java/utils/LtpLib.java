...
/**
 * Classe de servi�os de utilidade
 *
 */
...
// M�todos
    /**
     * M�todo validarData - Valida��o b�sica de Data
     * @param s String com a Data
     * @return true para data v�lida ou false para data inv�lida
     */

    public static boolean validarData(String wdata) {
        // Vetor Constante com N� max. de dias dos meses do ano
    ...
    /**
     * validarData verifica se o conteudo da String representa um data v�lida
     * @param wdata - String com a data
     * @param dt refer�ncia a um objeto da classe GregorianCalendar para receber a data v�lida
     * @return true para data v�lida ou false para data inv�lida
     */
	 ...
	 * validarData verifica se o conteudo da String representa um data v�lida
	 * @param wdata - String com a data
	 * @param dt refer�ncia a um objeto da classe java.sql.Date para receber a data v�lida
	 * @return true para data v�lida ou false para data inv�lida
	 */
	...
	/**
	 * validarHora verifica se o conteudo da String representa um hor�rio v�lido
	 * @param wdata - String com a data no formato h:m:s ou hh:mm:ss
	 * @return true para hor�rio v�lido ou false para hor�rio inv�lido
	 */
	...
	/**
	 * validarDataHora verifica se o conteudo da String representa um hor�rio v�lido
    ...
    /**
     * M�todo validarCPF - Valida��o do DV do CPF
    ...
    /**
     * M�todo validarCNPJ - Valida��o do DV do CNPJ
    ...
    /**
     * M�todo validarPIS - Valida��o do DV do PIS
    ...
    /**
     * M�todo validarEmail - Valida��o b�sica de E-mail
     * @param s String com a E-mail
     * @return true para E-Mail v�lido
     */
    ...
    /**
     * M�todo contarPalavras - Contar as palavras do texto
     * @param s String com o Texto
     * @return int com o n�mero de palavras do texto
     */
    ...
    /**
     * M�todo ajustarFimSemana - Ajusta data de fim de semana
    ...
    /**
     * M�todo padronizarTexto - Excluir espa�os a esquerda, a direita e excesso entre palavras do texto
     * @param s String com o Texto
     * @return String com o texto padronizado
     */
    public static String padronizarTexto (String s) {
        String resposta = "";
        String aux = s.trim(); // Inicializa aux com s retirando espa�os nas extremidades
        do {
            ...
            aux = aux.trim(); // retirar espa�os a esquerda
        } while (!aux.equals("")); //verificar se terminou?
        return resposta.trim();
    }
    /**
     * M�todo formatarData - formata uma data dt a partir de uma m�scara fmt
    ...
    /**
     * M�todo formatarValor - formata um valor a partir de uma m�scara
     * @param x - valor
     * @param s - M�scara
    ...
    /**
     * M�todo replicarStr - Replicar String
     * @param numStr - n�mero de copias
     * @param s - String
    ...
    /**
     * M�todo espacosLeft - Completar o campo com espa�os a esquerda
     * @param tamCampo - tamanho do campo
     * @param s - String s
     * @return String com espa�os a esquerda e com o tamanho especificado por tamCampo
     */
    ...
    /**
     * M�todo subtrairDatas - Mostrar como achar a diferen�a entre duas datas em dias
     * @param dt1 - data de inicio do intervalo
     * @param dt2 - data final do intervalo
     * @return inteiro tipo long com o n�mero de dias entre as datas
     */
    ...
    /**
     * M�todo subtrairHoras - Mostrar como achar a diferen�a entre duas datas / horas
     ...
     * @return tipo double com o n�mero de horas entre as datas
     */
    ...
    /**
     * M�todo formatarMilisegundos - Mostrar as horas formatada
     * @param miliseg - representa o hor�rio em milisegundos
    ...
    /**
     * M�todo valorExtenso - Mostrar o valor por extenso
    ...
    public static String valorExtenso(double valor){
        ...
        String [] vNomClasse = {"","Real","Reais","Mil","Mil","Milh�o","Milh�es","Bilh�o","Bilh�es",
                                      "Centavo","Centavos"};
...
//		 ----------------------------------------------------------;
    ...
    /**
    * M�todo lerArquivoObjetos - Ler a lista de objetos do arquivo de objetos, se ele existir
    * @param nomeArquivo - representa o nome do arquivo em que est� armazenado os objetos da lista
    * @return ArrayList - refer�ncia para a lista de objetos controlados pela classe ArrayList
    * @throws Exception - Exce��o de java.io
    */
    @SuppressWarnings("unchecked")
    public static ArrayList lerArquivoObjetos(String nomeArquivo) throws Exception {
    ...
    /**
     * M�todo lerArquivoObjetosArray - Ler a lista de objetos do arquivo de objetos, se ele existir
     * @param nomeArquivo - representa o nome do arquivo em que est� armazenado os objetos da lista
     * @return ArrayList - refer�ncia para a lista de objetos controlados pela classe ArrayList
     * @throws Exception - Exce��o de java.io
     */
    ...
    /**
    * M�todo gravarArquivoObjetos - Grava a listas de objetos em um arquivo de objetos
    * @param nomeArquivo - representa o nome do arquivo em que ser� gravado os objetos da lista
    * @param listaObjetos - refer�ncia para os objetos da lista controlados pela classe ArrayList
    * @throws Exception - Exce��o de java.io
    */
   @SuppressWarnings("unchecked")
   public static void gravarArquivoObjetos(String nomeArquivo, ArrayList listaObjetos) throws Exception {
    try {
   ...
   /**
    * M�todo gravarArquivoObjetosArray - Grava a listas de objetos em um arquivo de objetos
    * @param nomeArquivo - representa o nome do arquivo em que ser� gravado os objetos da lista
    * @param listaObjetos - refer�ncia para os objetos da lista controlados pela classe ArrayList
    * @throws Exception - Exce��o de java.io
    */
   ...
   // Retorna a maior data de admiss�o
   public static GregorianCalendar maiorDataAdm(GregorianCalendar[] datas) {
	   Arrays.sort(datas);
	   return datas[datas.length-1]; 
   }
   // Retornar um texto com padroniza��o especial
   ...
   // Retornar um array com as palavras em ordem alfab�tica
