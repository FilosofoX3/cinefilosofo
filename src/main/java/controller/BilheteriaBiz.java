...
//Inicializando salas de cinemas
	...
	/**
	 * m�todo que cadastra bilhete (venda)
	 *
	 * @param sessaoId
	 * @param vendedorId
	 * @param clienteId
	...
	/**
	 * m�todo que cadastra um extra em um bilhete
	 *
	 * @param extraId
	 * @param bilheteId
	 * @return
	...
	public List<SessaoEntity> procuraSessao(String titulo, java.sql.Date data, Long tecnologiaId) {
		...
		if (tecnologiaId != -1)  // op��o "Todas" selecionada
	...
	/**
	 * Retorna quantidade de poltronas vagas em uma sess�o
	 *
	 * @param sessaoId
	 * @return
	 */
